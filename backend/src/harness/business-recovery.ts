...
const recoveryPoliciesByStep: Record<string, BusinessRecoveryPolicy> = {
  ...
  match_resume_to_jd: {
    ...
    issueCodes: new Set([
      ...
      'MISSING_OPTIMIZATION_STRATEGY_DETAILS',
      'UNSTRUCTURED_OPTIMIZATION_SUGGESTIONS',
      'INCOMPLETE_OPTIMIZATION_STRATEGY_DETAIL',
      'INVALID_OPTIMIZATION_SOURCE_QUOTE',
      'ACTIONABLE_GAP_WITHOUT_STRATEGY',
    ]),
  },
