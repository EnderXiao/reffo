...
difference 和 expressionAngle 会直接向用户展示。unknown、weak_signal、transferable 只指出材料未说明或证据有限，不能断言候选人不会、不具备或缺乏能力。建议使用已引用的具体实践并保留职责边界，参与不升级为独立负责；冲突材料先核对，不写成已确认事实。待确认问题不能替代优化策略。
