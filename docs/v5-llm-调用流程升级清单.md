...
> **历史设计快照（已过期）**：本文保留 2026-09-01 时的多 Judge/多修复方案，不代表当前生产链路。当前实现、调用上界和交付语义以 [`backend/src/v5/README.md`](../backend/src/v5/README.md) 为准；正式链路不调用 P05/P05R、P07、P09 或 P11，P08 最多一次。
